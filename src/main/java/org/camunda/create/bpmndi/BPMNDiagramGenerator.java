...
public class BPMNDiagramGenerator {
    public static void generate(BPMNTemplate template, BpmnModelInstance modelInstance, String outputFilePath)  {
        try {
            ...
            for (int i = 0; i < sfNodes.getLength(); i++) {
                ...
                plane = DrawFlow.drawFlow(template, plane, modelInstance,sfElement, refPoints);
            }
            ...
            for (int i = 0; i < associationNodes.getLength(); i++) {
                ...
                plane = DrawFlow.drawFlow(template,plane, modelInstance,aElement, refPoints);
            }
