...
public class DrawFlow {
    ...
    public static BpmnPlane drawFlow(BPMNTemplate temp, BpmnPlane plane, ModelInstance modelInstance, Element sfElement, HashMap<String, SequenceReferencePoints> refPoints) {
